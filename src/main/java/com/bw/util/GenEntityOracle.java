...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/1707a?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("tb_goods","Goods","1707a").init();  
        new GenEntityOracle("tb_brand","Brand","1707a").init();
        new GenEntityOracle("tb_goodskind","Goodskind","1707a").init();
    }  
}